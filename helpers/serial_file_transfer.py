...
class SerialFileTransfer:
        ...
        with open(filename, 'rb') as f:
            ...
            for seq_num in range(num_full_packets):
                ...
                if seq_num % GROUP_SIZE == GROUP_SIZE - 1:
                    ...
                    result = self._send_missing_packets(f, filesize, num_full_packets)
    ...
    def _send_missing_packets(self, f, filesize, num_full_packets):
        ...
        for _ in range(MAX_RESEND_CYCLES):
            ...
            for seq_num in missing_packets:
                if seq_num == num_full_packets:
                    log.debug(f"Re-sending packet {seq_num} (partial last packet!)...")
